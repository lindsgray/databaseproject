...
export class MoviesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    },
    {
      ...
      review: {
        Anticipation: "4/5 - being Kubrick's last movie I expected him to go out with a bang.",
        Enjoyment: "Cruise's acting made a detriment that Kubrick's direction couldn't make up for.",
        inRetrospect: "3.5/5 - Kidman's acting and Kubrick's fondness of nudity give this film the following it has.",
